...
from constants.Texts import HOME_SUBTITLE, GLOBAL_STUDENT_TITLE_ADD, HOME_BUTTON_DELETE, HOME_BUTTON_EDIT, PROFESSOR_TITLE_ADD
...
def create_teacher_tab(notebook):
    ...
    new_teacher_button = tk.Button(top_frame, text=PROFESSOR_TITLE_ADD, bg=BUTTON_COLOR, fg=BUTTON_TEXT_COLOR, relief="flat", 
