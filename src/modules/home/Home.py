...
from constants.Texts import (HOME_TITLE, HOME_SUBTITLE, HOME_BUTTON_AGREGAR_ESTUDIANTE, HOME_BUTTON_EDITAR, HOME_BUTTON_BORRAR)
...
def show_home_view():
    ...
    label_title = tk.Label(home_window, text=HOME_SUBTITLE, bg=BACKGROUND_COLOR, fg=TITLE_COLOR, font=("Helvetica", 24, "bold"))
    label_title.pack(pady=20)

    top_frame = tk.Frame(home_window, bg=BACKGROUND_COLOR)
    top_frame.pack(pady=10)

    new_student_button = tk.Button(top_frame, text=HOME_BUTTON_AGREGAR_ESTUDIANTE, bg=BUTTON_COLOR, fg=BUTTON_TEXT_COLOR, relief="flat", 
    ...
    edit_button = tk.Button(actions_frame, text=HOME_BUTTON_EDITAR, bg=BUTTON_COLOR, fg=BUTTON_TEXT_COLOR, relief="flat", state="disabled")
